...
<!--
  Tip: a few screenshots make this guide much easier to follow.
  Upload PNGs into docs/screenshots/ and reference them under the relevant steps,
  for example: ![The Builder page](screenshots/builder.png)
-->
